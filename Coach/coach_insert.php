...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["button"])) {
        ...
        if ($idErr == "" && $nameErr == "" && $positionErr == "" && $salaryErr == "" && $ageErr == "" && $joinErr == "" && $endErr == "") {
            $sql = "INSERT INTO coach (coach_id,coach_name,position,join_date,end_date,salary,age)
            VALUES ('$id', '$name','$position', '$joinDate','$endDate','$salary','$age')";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Coach/coach_insert.css">
